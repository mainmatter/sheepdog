...
`@sheepdog/svelte` supplies a simple way to introduce cancelable concurrency into your app. Not only
do we provide the "cancelability" that is missing from normal Promises, `@sheepdog/svelte` also
