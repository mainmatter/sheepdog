...
<Aside>
	This is the way we recommend using `@sheepdog/svelte` but it is optional. To understand more about the Async Transform, check out the [guide](/guides/async-transform)
</Aside>
